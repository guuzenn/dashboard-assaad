    ...
    <nav class="backdrop-blur-lg bg-white/30 w-full fixed top-0 left-0 z-50 h-20">
        <div class="max-w-6xl mx-auto flex justify-between items-center px-4 py-3">
            ...
            <ul id="menu" class="hidden md:flex flex-col md:flex-row gap-6 absolute md:static top-20 left-0 w-full md:w-auto bg-white md:bg-transparent p-4 md:p-0 shadow md:shadow-none">
                ...
                <li><a href="{{ route('compro.kontak') }}" class="text-base text-green-700 font-semibold hover:font-semibold hover:text-green-700">Kontak</a></li>
            </ul>
        </div>
    </nav>
    <section class="py-16 max-w-6xl mx-auto px-4 text-center m-16">
        <h2 class="text-5xl font-bold text-green-700 mb-6">Kontak & Lokasi</h2>
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div class="text-left text-lg text-gray-700 space-y-4">
                <p><strong>Alamat:</strong> Jl. Pendidikan No. 1, Kota Bahagia</p>
                <p><strong>Email:</strong> info@sekolahislamku.sch.id</p>
                <p><strong>Telp:</strong> 0812-3456-7890</p>
                <p><strong>Jam Operasional:</strong> Senin–Jumat, 07.00–13.00</p>
            </div>
            <div>
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3319.869901247508!2d106.97149209999999!3d-6.360807699999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69930070d7a825%3A0xbd786d6ce9bbb72e!2sTK%20As-Sa&#39;ad%20Islamic%20Kindergarten!5e1!3m2!1sen!2sid!4v1746022080918!5m2!1sen!2sid"
                    width="100%" height="300" class="rounded-xl border-4 border-orange-300 shadow-lg" allowfullscreen></iframe>
            </div>
        </div>
    </section>
