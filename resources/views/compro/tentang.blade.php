...
<body class="bg-green-50 font-['Fredoka']">
    ...
    <section class="py-16 max-w-6xl mx-auto px-4 text-center mt-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href="/assets/images/compro/tkA.png" class="image-link">
                <img src="/assets/images/compro/tkA.png" class="rounded-xl shadow-md hover:scale-105 transition" />
            </a>
            <a href="/assets/images/compro/tkA.png" class="image-link">
                <img src="/assets/images/compro/tkA.png" class="rounded-xl shadow-md hover:scale-105 transition" />
            </a>
    ...
    <div id="imageModal" class="fixed inset-0 bg-black bg-opacity-75 hidden justify-center items-center z-50">
        <span id="closeModal" class="absolute top-4 right-6 text-white text-4xl cursor-pointer">&times;</span>
        <img id="modalImg" class="max-w-3xl w-full rounded-lg shadow-lg border-4 border-white" />
    </div>
    <script>
        ...
        imageLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                e.preventDefault(); // supaya tidak membuka halaman baru
