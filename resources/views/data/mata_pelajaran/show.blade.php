<x-layout>
   ...
   <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
         <h4 class="text-lg font-bold text-black dark:text-white mb-4">Detail Mata Pelajaran</h4>
         <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
               <h3 class="font-medium text-black dark:text-white">Informasi Mata Pelajaran</h3>
            </div>
            <div class="p-6.5 grid grid-cols-1 gap-y-5 sm:grid-cols-2 sm:gap-x-8">
               <!-- Nama Mata Pelajaran -->
               <div>
                  <p class="text-sm text-slate-500 mb-1">Nama Mata Pelajaran</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $mataPelajaran->nama }}</p>
               </div>
               <!-- Tombol Kembali -->
               <div class="sm:col-span-2 flex justify-end mt-6">
                  <a href="{{ route('data.mata_pelajaran.index') }}" class="px-4 py-2 text-white bg-primary rounded-md hover:bg-primary-dark">
                     Kembali
                  </a>
               </div>
            </div>
