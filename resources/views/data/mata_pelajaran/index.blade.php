         ...
         <div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1 mt-6">
            ...
            <div class="max-w-full overflow-x-auto">
               ...
               <table class="w-full table-auto">
                  ...
                  <tbody>
                     @foreach ($mataPelajarans as $index => $item)
                     <tr>
                        ...
                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            <form action="{{ route('data.mata_pelajaran.destroy', $item->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
                           <div class="flex items-center space-x-3.5">
                              <!-- Button Show -->
                              <a href="{{ route('data.mata_pelajaran.show', $item->id) }}" class="hover:text-primary">
                                 <svg
                                    class="fill-current"
                                    width="18"
                                    height="18"
                              ...
                              <!-- Button Edit -->
                              <a href="{{ route('data.mata_pelajaran.edit', $item->id) }}" class="hover:text-primary">
                                 <svg
                                    class="fill-current"
                                    width="18"
                                    height="18"
