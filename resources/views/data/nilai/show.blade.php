<x-layout>
 ...
 <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
         <h4 class="text-lg font-bold text-black dark:text-white mb-4">Detail Nilai Murid</h4>
         <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
               <h3 class="font-medium text-black dark:text-white">Informasi Nilai</h3>
            </div>
            <div class="p-6.5 grid grid-cols-1 gap-y-5 sm:grid-cols-2 sm:gap-x-8">
               ...
               <div>
                  ...
                  <p class="text-base font-medium text-black dark:text-white">{{ ucfirst($nilai->semester) }}</p>
               </div>
               <!-- Nilai Rata-rata -->
               <div>
