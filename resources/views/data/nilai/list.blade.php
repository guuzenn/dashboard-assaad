<x-layout>
   ...
   <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
         <h4 class="text-lg font-bold text-black dark:text-white mb-4">Data Nilai</h4>
            ...
            <table class="w-full table-auto">
               <thead>
                  <tr class="bg-gray-2 text-left dark:bg-meta-4">
                     ...
                     <th class="min-w-[220px] px-4 py-4 font-medium text-black dark:text-white">Mata Pelajaran</th>
                     <th class="min-w-[100px] px-4 py-4 font-medium text-black dark:text-white">Semester</th>
                     <th class="min-w-[120px] px-4 py-4 font-medium text-black dark:text-white">Nilai Rata-rata</th>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <form action="{{ route('data.nilai.destroy', $item->id) }}" method="POST" class="form-delete">
                            @csrf
                            @method('DELETE')
                     <div class="flex items-center space-x-3.5">
                             ...
                             <a href="{{ route('data.nilai.show', $item->id) }}" class="hover:text-primary">
                              ...
                              <!-- Button Edit -->
                              <a href="{{ route('data.nilai.edit', $item->id) }}" class="hover:text-primary">
                                 <svg
                                    class="fill-current"
                                    width="18"
                                    height="18"
