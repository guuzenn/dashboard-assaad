<x-layout>
  ...
  <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
         <h4 class="text-lg font-bold text-black dark:text-white mb-4">Edit Murid</h4>
                    ...
                    <div class="flex flex-col gap-5.5 p-6.5">
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Islam" @selected(old('agama', $murid->agama) == 'Islam')>Islam</option>
                                <option value="Kristen" @selected(old('agama', $murid->agama) == 'Kristen')>Kristen</option>
                                <option value="Katolik" @selected(old('agama', $murid->agama) == 'Katolik')>Katolik</option>
                                <option value="Hindu" @selected(old('agama', $murid->agama) == 'Hindu')>Hindu</option>
                                <option value="Buddha" @selected(old('agama', $murid->agama) == 'Buddha')>Buddha</option>
                                <option value="Konghucu" @selected(old('agama', $murid->agama) == 'Konghucu')>Konghucu</option>
                            </select>
                            @error('agama')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Laki-laki" @selected(old('jenis_kelamin', $murid->jenis_kelamin) == 'Laki-laki')>Laki-laki</option>
                                <option value="Perempuan" @selected(old('jenis_kelamin', $murid->jenis_kelamin) == 'Perempuan')>Perempuan</option>
                            </select>
                            @error('jenis_kelamin')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
