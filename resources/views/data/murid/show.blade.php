<x-layout>
   ...
   <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
         <h4 class="text-lg font-bold text-black dark:text-white mb-4">Detail Murid</h4>
         <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
               <h3 class="font-medium text-black dark:text-white">Informasi Murid</h3>
            </div>
            <div class="p-6.5 grid grid-cols-1 gap-y-5 sm:grid-cols-2 sm:gap-x-8">
               <!-- Nama Lengkap -->
               <div>
                  <p class="text-sm text-slate-500 mb-1">Nama Lengkap</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->nama_lengkap }}</p>
               </div>
               <!-- Tanggal Lahir -->
               <div>
                  <p class="text-sm text-slate-500 mb-1">Tanggal Lahir</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->tanggal_lahir }}</p>
               </div>
               <!-- Agama -->
               <div>
                  <p class="text-sm text-slate-500 mb-1">Agama</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->agama }}</p>
               </div>
               <!-- Jenis Kelamin -->
               <div>
                  <p class="text-sm text-slate-500 mb-1">Jenis Kelamin</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->jenis_kelamin }}</p>
               </div>
               <!-- Riwayat Penyakit -->
               <div>
                  <p class="text-sm text-slate-500 mb-1">Riwayat Penyakit</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->riwayat_penyakit ?? 'Tidak Ada' }}</p>
               </div>
               <!-- Alamat -->
               <div class="sm:col-span-2">
                  <p class="text-sm text-slate-500 mb-1">Alamat</p>
                  <p class="text-base font-medium text-black dark:text-white whitespace-pre-line">{{ $murid->alamat }}</p>
               </div>
               <!-- Orang Tua -->
               <div>
                  <p class="text-sm text-slate-500 mb-1">Nama Ayah</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->nama_ayah }}</p>
               </div>
               <div>
                  <p class="text-sm text-slate-500 mb-1">Pekerjaan Ayah</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->pekerjaan_ayah }}</p>
               </div>
               <div>
                  <p class="text-sm text-slate-500 mb-1">No HP Ayah</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->hp_ayah }}</p>
               </div>
               <div>
                  <p class="text-sm text-slate-500 mb-1">Nama Ibu</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->nama_ibu }}</p>
               </div>
               <div>
                  <p class="text-sm text-slate-500 mb-1">Pekerjaan Ibu</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->pekerjaan_ibu }}</p>
               </div>
               <div>
                  <p class="text-sm text-slate-500 mb-1">No HP Ibu</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->hp_ibu }}</p>
               </div>
               <!-- Kelas -->
               <div>
                  <p class="text-sm text-slate-500 mb-1">Kelas</p>
                  <p class="text-base font-medium text-black dark:text-white">{{ $murid->kelas->nama }}</p>
               </div>
               <!-- Back Button -->
               <div class="sm:col-span-2 flex justify-end mt-6">
                  <a href="{{ route('data.murid.index') }}" class="px-4 py-2 text-white bg-primary rounded-md hover:bg-primary-dark">
                  Kembali
                  </a>
               </div>
            </div>
