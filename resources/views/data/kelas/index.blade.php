<x-layout>
   ...
   <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
         <h4 class="text-lg font-bold text-black dark:text-white mb-4">Data Kelas</h4>
         <!-- Card Statistik -->
            ...
            <div class="flex items-center justify-between mb-4">
               ...
               <div class="flex items-center gap-4">
                  ...
                  <button
                     ...
                     @click="window.location.href='{{ route('data.kelas.create') }}'"
                  >
                     Tambah Kelas
                  </button>
               </div>
               ...
               <table class="w-full table-auto">
                  <thead>
                     <tr class="bg-gray-2 text-left dark:bg-meta-4">
                        ...
                        <th class="min-w-[150px] px-4 py-4 font-medium text-black dark:text-white">Nama Kelas</th>
                        <th class="min-w-[120px] px-4 py-4 font-medium text-black dark:text-white">Total Murid</th>
                        <th class="min-w-[120px] px-4 py-4 font-medium text-black dark:text-white">Tahun Ajar</th>
                        <th class="min-w-[180px] px-4 py-4 font-medium text-black dark:text-white">Wali Kelas</th>
                     ...
                     <tr>
                        ...
                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                           ...
                           <div class="flex items-center space-x-3.5">
                              ...
                              <!-- Button Edit -->
                              <a href="{{ route('data.kelas.edit', $item->id) }}" class="hover:text-primary">
                                 <svg
                                    class="fill-current"
                                    width="18"
                                    height="18"
