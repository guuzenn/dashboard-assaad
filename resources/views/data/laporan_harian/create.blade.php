<x-layout>
    ...
    <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <h4 class="text-lg font-bold text-black dark:text-white mb-4">Tambah Laporan Harian</h4>

            <form action="{{ route('data.laporan_harian.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                    ...
                    <div class="flex flex-col gap-9">
                        <div
                            ...
                            <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                                <h3 class="font-medium text-black dark:text-white">Form Tambah Laporan Harian</h3>
                            </div>
                            ...
                            <div class="flex flex-col gap-5.5 p-6.5">
                                ...
                                <!-- Judul Kegiatan -->
                                <div>
                                    <label class="mb-3 block text-sm font-medium text-black dark:text-white">Judul
                                        Kegiatan</label>
                                    <input type="text" name="judul" placeholder="Contoh: Kegiatan Mewarnai"
                                ...
                                <div>
                                    <label
                                        class="mb-3 block text-sm font-medium text-black dark:text-white">Deskripsi</label>
                                    <textarea name="deskripsi" placeholder="Masukkan deskripsi kegiatan"
                                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">{{ old('deskripsi') }}</textarea>
                                    @error('deskripsi')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
