<x-layout>
    ...
    <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <h4 class="text-lg font-bold text-black dark:text-white mb-4">Laporan Harian</h4>
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative">
                            ...
                            <span class="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2">
                                <svg width="14" height="10" viewBox="0 0 10 6" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M0.47 1.088C0.47 1.03 0.5 0.956 0.544 0.912C0.647 0.809 0.809 0.809 0.912 0.897L4.854 4.604C4.928 4.677 5.06 4.677 5.149 4.604L9.091 0.897C9.194 0.794 9.356 0.809 9.459 0.912C9.562 1.015 9.547 1.177 9.444 1.279L5.502 4.986C5.222 5.236 4.781 5.236 4.516 4.986L0.559 1.279C0.5 1.221 0.47 1.162 0.47 1.088Z"
                                        fill="#637381" />
                                </svg>
                            </span>
                        </div>
                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr class="bg-gray-2 text-left dark:bg-meta-4">
                                ...
                                <th class="min-w-[200px] px-4 py-4 font-medium text-black dark:text-white">Judul
                                    Kegiatan</th>
                                ...
                                <tr>
                                    ...
                                    <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                                        ...
                                        <div class="flex items-center space-x-3.5">
                                            ...
                                            <!-- Button Edit -->
                                            <a href="{{ route('data.laporan_harian.edit', $item->id) }}"
                                                class="hover:text-primary">
                                                <svg class="fill-current" width="18" height="18"
