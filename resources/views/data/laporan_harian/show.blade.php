        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div class="p-6.5 grid grid-cols-1 gap-y-5 sm:grid-cols-2 sm:gap-x-8">
                    <!-- Judul Kegiatan -->
                    <div>
                        <p class="text-sm text-slate-500 mb-1">Judul Kegiatan</p>
                        <p class="text-base font-medium text-black dark:text-white">{{ $laporan->judul }}</p>
                    </div>
                    <!-- Tanggal -->
                    <div>
                        <p class="text-sm text-slate-500 mb-1">Tanggal</p>
                        <p class="text-base font-medium text-black dark:text-white">{{ $laporan->tanggal }}</p>
                    </div>
                    <!-- Kelas -->
                    <div>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <p class="text-base font-medium text-black dark:text-white">{{ $laporan->deskripsi }}</p>
                    </div>
                    <!-- Foto -->
                    <div class="sm:col-span-2">
