                ...
                <div class="flex flex-col gap-9">
                    <div
                        ...
                        <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                            <h3 class="font-medium text-black dark:text-white">Form Edit Laporan</h3>
                        </div>
                        ...
                        <div class="flex flex-col gap-5.5 p-6.5">
                                ...
                                <div>
                                    ...
                                    <textarea name="deskripsi" placeholder="Masukkan Deskripsi"
                                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white">{{ old('deskripsi', $laporan->deskripsi) }}</textarea>
                                    @error('deskripsi')
                                        <span class="text-red-500 text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
