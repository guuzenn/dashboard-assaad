<x-layout>
   ...
   <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
         <h4 class="text-lg font-bold text-black dark:text-white mb-4">Manajemen Akun</h4>
            ...
            <div
               ...
               <div class="mt-4 flex items-end justify-between">
                  <div>
                     ...
                     <span class="text-sm font-medium">Akun Terblokir</span>
                  </div>
               </div>
            </div>
            <!-- Card Item End -->
         ...
         <div
            ...
            <div class="flex items-center justify-between mb-4">
               <h4 class="text-lg font-bold text-black dark:text-white">List Akun</h4>
               <div class="flex items-center gap-4">
                  ...
                  <button
                     ...
                     @click="window.location.href='{{ route('admin.akun.create') }}'"
                  >
                     Tambah Akun
                  </button>
               </div>
                     ...
                     <tr>
                        ...
                        <td class="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                           ...
                           <div class="flex items-center space-x-3.5">
                               <!-- Button Show -->
                             <a href="{{ route('admin.akun.show', $item['id']) }}" class="hover:text-primary">
                                 <svg
                                    class="fill-current"
                                    width="18"
                                    height="18"
