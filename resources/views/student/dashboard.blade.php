...
<header class="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
   ...
   <main>
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <h4 class="text-lg font-bold text-black dark:text-white mb-6">Dashboard Siswa</h4>

            <!-- Status SPP Box -->
            <div class="rounded-lg border border-stroke bg-white p-6 shadow-md dark:border-strokedark dark:bg-boxdark mb-8">
                <h5 class="text-base font-semibold text-red-500 mb-4">Status SPP</h5>
            ...
            <!-- Akses Cepat -->
            <h5 class="text-lg font-bold text-black dark:text-white mb-4 mt-6">Akses Cepat</h5>
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
                <!-- Ajukan Cicilan -->
                <a href="{{ route('student.pembayaran.cicilan.create') }}"
                    class="rounded-lg border border-stroke bg-white p-6 shadow-md transition hover:shadow-lg hover:-translate-y-1 dark:border-strokedark dark:bg-boxdark">
                    <div class="flex items-center justify-center mb-3">
                        <svg class="fill-primary dark:fill-white" width="28" height="28" viewBox="0 0 24 24">
                            <path d="M12 1a11 11 0 1 0 0 22A11 11 0 0 0 12 1Zm0 20a9 9 0 1 1 0-18 9 9 0 0 1 0 18ZM12 6a1 1 0 0 1 1 1v4h2a1 1 0 1 1 0 2h-3a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1Z"/>
                        </svg>
                    </div>
                    <h6 class="text-center font-semibold text-primary mb-1">Ajukan Cicilan</h6>
                    <p class="text-xs text-center text-gray-500 dark:text-gray-300">Ajukan permohonan cicilan pembayaran SPP</p>
                </a>
                ...
                <a href="{{ route('student.laporan_harian.index') }}"
                    ...
                    <h6 class="text-center font-semibold text-primary mb-1">Lihat Laporan</h6>
                    <p class="text-xs text-center text-gray-500 dark:text-gray-300">Lihat laporan kegiatan harian yang sudah dikirim</p>
                </a>
                ...
                <a href="{{ route('student.profile') }}"
                    ...
                    <div class="flex items-center justify-center mb-3">
                        <svg class="fill-primary dark:fill-white" width="28" height="28" viewBox="0 0 24 24">
                            <path d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10ZM2 20a10 10 0 0 1 20 0v2H2v-2Z"/>
                        </svg>
                    </div>
                    <h6 class="text-center font-semibold text-primary mb-1">Lihat Profil</h6>
                    <p class="text-xs text-center text-gray-500 dark:text-gray-300">Periksa informasi profil pribadi kamu</p>
                </a>
            </div>
        </div>
    </main>
