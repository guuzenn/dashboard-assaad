            ...
            <ul class="mb-6 flex flex-col gap-1.5">
               ...
               <li>
                  <a href="{{ route('ppdb.index') }}"
                     class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out
                     hover:bg-graydark dark:hover:bg-meta-4
                     {{ Request::is('ppdb*') ? 'bg-graydark text-white dark:bg-meta-4' : 'text-bodydark1' }}">
                     <!-- SVG PPDB -->
               ...
               <li>
                  <a href="{{ route('data.murid.index') }}"
                     class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out
                     hover:bg-graydark dark:hover:bg-meta-4
                     {{ Request::is('data/murid*') ? 'bg-graydark text-white dark:bg-meta-4' : 'text-bodydark1' }}">
                     <!-- SVG Murid -->
                     <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
               ...
               <li>
                  <a href="{{ route('data.guru.index') }}"
                     class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out
                     hover:bg-graydark dark:hover:bg-meta-4
                     {{ Request::is('data/guru*') ? 'bg-graydark text-white dark:bg-meta-4' : 'text-bodydark1' }}">
                     <!-- SVG Guru -->
                     <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
               ...
               <li>
                  <a href="{{ route('data.kelas.index') }}"
                     class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out
                     hover:bg-graydark dark:hover:bg-meta-4
                     {{ Request::is('data/kelas*') ? 'bg-graydark text-white dark:bg-meta-4' : 'text-bodydark1' }}">
                     <!-- SVG Kelas -->
                     <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
               ...
               <li>
                  <a href="{{ route('data.nilai.index') }}"
                     class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out
                     hover:bg-graydark dark:hover:bg-meta-4
                     {{ Request::is('data/nilai*') ? 'bg-graydark text-white dark:bg-meta-4' : 'text-bodydark1' }}">
                     <!-- SVG Nilai -->
                     <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
               ...
               <!-- Menu Item Mata Pelajaran -->
               <li>
                <a href="{{ route('data.mata_pelajaran.index') }}"
                   class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out
                   hover:bg-graydark dark:hover:bg-meta-4
                   {{ Request::is('data/mapel*') ? 'bg-graydark text-white dark:bg-meta-4' : 'text-bodydark1' }}">
                   <!-- SVG Nilai -->
                   <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
             ...
             <li>
                <a href="{{ route('data.pivot_mapel_kelas.index') }}"
                   class="group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium duration-300 ease-in-out
                   hover:bg-graydark dark:hover:bg-meta-4
                   {{ Request::is('data/pivot_mapel_kelas*') ? 'bg-graydark text-white dark:bg-meta-4' : 'text-bodydark1' }}">
                   <!-- SVG Nilai -->
                   <svg class="fill-current" width="18" height="18" viewBox="0 0 24 24" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M3 13.125C3 12.504 3.504 12 4.125 12h2.25c.621 0 1.125.504 1.125 1.125v6.75C7.5 20.496 6.996 21 6.375 21h-2.25A1.125 1.125 0 0 1 3 19.875v-6.75ZM9.75 8.625c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125v11.25c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V8.625ZM16.5 4.125c0-.621.504-1.125 1.125-1.125h2.25C20.496 3 21 3.504 21 4.125v15.75c0 .621-.504 1.125-1.125 1.125h-2.25a1.125 1.125 0 0 1-1.125-1.125V4.125Z" />
