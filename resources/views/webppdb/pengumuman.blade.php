...
<body class="bg-gray-100 font-['Fredoka']">
    <div class="flex">
        ...
        <aside class="w-64 bg-white shadow-md h-screen fixed top-0 left-0 flex flex-col">
            ...
            <nav class="flex-1 px-4 space-y-4 text-gray-700">
                ...
                <a href="pengumuman.html" class="flex items-center space-x-2 p-2 bg-gradient-to-r from-[#388E3C] to-white text-white rounded-md">
    ...
    <script>
        ...
        const sudahUpload = localStorage.getItem('uploadSelesai') === 'true';
