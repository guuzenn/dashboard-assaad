    ...
    <div class="flex">
        ...
        <aside class="w-64 bg-white shadow-md h-screen fixed top-0 left-0 flex flex-col">
            ...
            <nav class="flex-1 px-4 space-y-4 text-gray-700">
                <nav class="flex-1 px-4 space-y-4 text-gray-700">
                    <a href="{{ route('beranda') }}" class="flex items-center space-x-2 p-2 rounded-md
                        {{ request()->routeIs('beranda') ? 'bg-gradient-to-r from-[#388E3C] to-white text-white' : 'hover:bg-gray-100 text-gray-700' }}">
                        <span class="{{ request()->routeIs('beranda') ? 'text-white' : 'text-gray-700' }}">
