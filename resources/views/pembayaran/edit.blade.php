                    ...
                    <div class="flex flex-col gap-9">
                        <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                            ...
                            <div class="flex flex-col gap-5.5 p-6.5">
                                <!-- Nama Siswa -->
                                <div>
                                    <label class="mb-3 block text-sm font-medium text-black dark:text-white">Nama Siswa</label>
                                    <input type="text" name="siswa" value="{{ old('siswa', $pembayaran['siswa']) }}" placeholder="Nama Siswa"
                                ...
                                <div>
                                    ...
                                    <select name='judul"
                                        ...
                                        <option value="Daftar Ulang" @selected($pembayaran['jenis'] == 'Daftar Ulang')>Daftar Ulang</option>
                                    </select>
                                </div>

                                <!-- Nominal -->
                                <div>
                                    <label class="mb-3 block text-sm font-medium text-black dark:text-white">Nominal Bayar</label>
                                    <input type="number" name="nominal" value="{{ old('nominal', $pembayaran['nominal']) }}" placeholder="Nominal Bayar"
                                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition
                                        focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="metode" value="{{ old('metode', $pembayaran['metode']) }}" placeholder="Metode Pembayaran"
                                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition
                                        focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                </div>
                                ...
                                <!-- Tanggal Bayar -->
                                <div>
                                    <label class="mb-3 block text-sm font-medium text-black dark:text-white">Tanggal Bayar</label>
                                    <input type="date" name="tanggal" value="{{ old('tanggal', $pembayaran['tanggal']) }}"
                                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition
                                        focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                </div>
                                ...
                                <div>
                                    ...
                                    <select name="status"
                                        class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition
                                        focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
                                        <option value="Lunas" @selected($pembayaran['status'] == 'Lunas')>Lunas</option>
                                        <option value="Cicilan" @selected($pembayaran['status'] == 'Cicilan')>Cicilan</option>
                                        <option value="Belum Bayar" @selected($pembayaran['status'] == 'Belum Bayar')>Belum Bayar</option>
                                    </select>
                                </div>
