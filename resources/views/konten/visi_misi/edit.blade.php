<x-layout>
  ...
  <main>
      <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
         <h4 class="text-lg font-bold text-black dark:text-white mb-4">Edit Konten</h4>
            ...
            <div class="flex flex-col gap-9">
               ...
               <div class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                  <div class="border-b border-stroke px-6.5 py-4 dark:border-strokedark">
                     <h3 class="font-medium text-black dark:text-white">Form Edit Visi Misi</h3>
                  </div>

                  <form action="{{ route('konten.visi_misi.update', $data->id) }}" method="POST" class="flex flex-col gap-5.5 p-6.5">
                     @csrf
                     @method('PUT')
                     ...
                     <div>
                           ...
                           >
                              ...
                              <option value="Visi" @selected(old('judul', $data->judul) == 'Visi')>Visi</option>
                              <option value="Misi" @selected(old('judul', $data->judul) == 'Misi')>Misi</option>
                           </select>
                           @error('judul')
                     ...
                     <div>
                           ...
                           <textarea
                              ...
                              class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                           >{{ old('konten', $data->konten) }}</textarea>
                           @error('konten')
                              <span class="text-red-500 text-sm">{{ $message }}</span>
                           @enderror
                     </div>
