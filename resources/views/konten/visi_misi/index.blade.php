            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-2 2xl:gap-7.5">
                ...
                <div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1 mt-6">
                    ...
                    <button
                        ...
                        @click="window.location.href='{{ route('visi-misi.create') }}'"
                        >
                    Tambah
                    </button>
                    </div>
                    ...
                    <table class="w-full table-auto">
                        <thead>
                            <tr class="bg-gray-2 text-left dark:bg-meta-4">
                                ...
                                <th class="min-w-[100px] px-4 py-4 font-medium text-black dark:text-white">Konten</th>
                                <th class="min-w-[60px] px-4 py-4 font-medium text-black dark:text-white">Terakhir Diupdate</th>
